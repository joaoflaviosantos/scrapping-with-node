...
import { isLastPage, navigateNextPage, navigateResults } from "./googleNavigation.js";
...
// https://github.com/apify/crawlee/discussions/1567
router.addHandler( Labels.domainUrl, async ({ request, $, log, sendRequest }) => {
